...
export class ContentComponent implements OnInit {
  ...
  public getLocalizedString$(stringId: StringIdsType | StringIdsType[]): Observable<string> {
    if (stringId instanceof Array){
      stringId.forEach(string=>{
        console.log(this.translate.stream(string))
      })
    }
    return this.translate.stream(stringId[0]);
  }
  ngOnInit(): void {
